...
*/
  ...
  return (
    <form className="form" onSubmit={handleSubmit}>
      ...
      <input className="name-input" type="text" maxLength={16} placeholder="Karakterinizin Adını Girin" required disabled={submitted ? true:false} value={playerName} onChange={(e)=>{setPlayerName(e.target.value)}}/>
